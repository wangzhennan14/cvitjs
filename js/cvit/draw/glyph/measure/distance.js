 ...
 * @author awilkey
 * @module draw/glyph/measure/distance
 *
 */
...
define(['jquery', 'glyph/utilities'],
  function ($, utility) {
    ...
    return /** @alias module:draw/glyph/measure/range */ {
      ...
      /**
       * @description Draws the given feature as a distance.
       *
       * @param {object} distance - The range to draw.
      ...
      draw: function (distance, group, view, glyphGroup) {
      }
    };
  }
);