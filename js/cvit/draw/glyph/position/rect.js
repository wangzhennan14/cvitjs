/**
 * @file Sub-glyph for drawing positions as a rectangle, a feature with length placed beside the chromosome
 *      with user-defined size.
 * @author awilkey
 * @module draw/glyph/position/rect
 *
 */
...
define(['jquery', 'glyph/utilities'],
  function ($, utility) {
    return /** @alias module:draw/glyph/position/rect */ {
      ...
      /**
       * @description Draws a positional rectangle.
       *
